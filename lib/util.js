...
const msg = {
  ...
  docs: () => {
    console.info(chalk.green(' [开发文档] https://github.com/dusunboy/f-cli'));
  },
  issues: () => {
    console.info(chalk.green('[问题留言] https://github.com/dusunboy/f-cli/issues'));
  },
  fail: (spinner, str, err) => {
    ...
    console.info(chalk.blue('[问题留言] https://github.com/dusunboy/f-cli/issues'));
    process.exit();
  }
};
